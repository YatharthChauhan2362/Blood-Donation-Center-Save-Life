        ...
        <div class="col-md-12 col-md-push-1">
            <div class="panel panel-default" style="padding: 20px;">
                ...
                <?php   if (isset($submitError)) echo $submitError;?>
                    ...
                    <div class="test-success text-center" id="data" style="margin-top: 20px;"><?php if(isset($showForm))  echo $showForm;?>
                    ...
                    <button style="margin-top: 20px;" name="date" id="save_the_life" type="submit"
                ...
                <span>You already have donated the blood.You will be able to donate the blood after three months.We are very grateful for your donation. </span>
                </div>';
                            }
                        }
